...
Фото устройства датчика с номером 0 265 019 012. Датчик с номером 0 265 019 153 устроен аналогично, но [применяемые микросхемы отличаются](./0_265_019_153_hw.md).
